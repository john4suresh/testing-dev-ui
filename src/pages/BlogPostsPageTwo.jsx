            ...
            <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
                <div className="mt-10 space-y-6">
                    ...
                    <p className="text-lg leading-7 text-gray-600">
                        ...
                        <br />
                        <br />
                        <b> User testing tools: </b>
                        These tools help you test your UI/UX design with users,
                        ...
                        <b>Survey tools:</b>
                        {" "}
                        These tools help you collect data from users through online
                        surveys. Some popular survey tools include Google Forms, SurveyMonkey, and Typeform.
                        <br />
                        <br />
                        <b>Analytics tools:</b>
                        {" "}
                        Analytics tools help you track user behavior and gather data on
                        how users interact with your UI/UX design. Some popular analytics tools include Google
                        Analytics, Mixpanel, and Kissmetrics.
                        <br />
                        <br />
                        <b>Prototyping tools:</b>
                        {" "}
                        Prototyping tools help you create interactive prototypes of
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="grid gap-y-4 lg:grid-cols-2">
                        <div className="space-y-4">
                            ...
                            <button type="button" className="rounded-lg border border-purple-500 bg-purple-500 px-5 py-3 text-base font-semibold text-white shadow">
                                View all posts
                            </button>
                        </div>
...
export default BlogPostsPageTwo;
