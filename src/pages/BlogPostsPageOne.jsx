    ...
    <div className="bg-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-center space-y-8 py-20">
          ...
          <p className="text-center text-5xl font-semibold  text-gray-900">
        ...
        <div className="my-6">
          <img
            className="aspect-[16/6] rounded-lg object-cover"
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-6 flex items-center justify-between border-t border-gray-200 py-4">
          ...
          <div className="flex ">
            <img
              className="mr-4 h-14 w-14 rounded-lg"
...
BlogPostsPageOne.displayName = 'BlogPostsPageOne'
