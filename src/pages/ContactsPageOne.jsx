            ...
            <div className="grid items-center justify-items-center gap-x-4 gap-y-10 px-8  lg:grid-cols-2">
                ...
                <div className="flex  items-center justify-center">
                    <div className="space-y-5 px-12">
                        ...
                        <button type="button" className="w-full rounded-md bg-indigo-600 px-3.5 py-1.5 text-base font-semibold leading-7 text-white hover:bg-indigo-500 ">
                            Send message
                        </button>
                    </div>
                </div>
...
export default ContactsPageOne;
